...
import { decodeState, exchangeCodeForTokens, isOAuthConfigured, storeUserGoogleTokens } from '@/lib/google/oauth';
...
export async function GET(request) {
  ...
  const redirectUrl = new URL(redirectTarget, `${currentUrl.protocol}//${currentUrl.host}`);
