...
async function seed() {
  ...
  const categories = [
    // Bebidas e infusiones
    {
      ...
      slug: "bebidas-e-infusiones",
      parent_id: null,
      path: ["bebidas-e-infusiones"],
      depth: 0,
    },
    {
      name: "Bebidas alcohólicas",
      slug: "bebidas-alcoholicas",
      parent_id: "bebidas-e-infusiones",
      path: ["bebidas-e-infusiones", "bebidas-alcoholicas"],
      depth: 1,
    },
    {
      name: "Cervezas",
      slug: "cervezas",
      parent_id: "bebidas-alcoholicas",
      path: ["bebidas-e-infusiones", "bebidas-alcoholicas", "cervezas"],
      depth: 2,
    },
    {
      name: "Vinos, licores y otras",
      slug: "vinos-licores-otras",
      parent_id: "bebidas-alcoholicas",
      path: [
        "bebidas-e-infusiones",
        "bebidas-alcoholicas",
    ...
    {
      name: "Rones y whiskys",
      slug: "rones-whiskys",
      parent_id: "bebidas-alcoholicas",
      path: ["bebidas-e-infusiones", "bebidas-alcoholicas", "rones-whiskys"],
      depth: 2,
    },
    {
      ...
      parent_id: "bebidas-e-infusiones",
      path: ["bebidas-e-infusiones", "bebidas-sin-alcohol"],
      depth: 1,
    },
    {
      name: "Bebidas gaseadas",
      slug: "bebidas-gaseadas",
      parent_id: "bebidas-sin-alcohol",
      path: ["bebidas-e-infusiones", "bebidas-sin-alcohol", "bebidas-gaseadas"],
      depth: 2,
    },
    {
      name: "Jugos",
      slug: "jugos",
      parent_id: "bebidas-sin-alcohol",
      path: ["bebidas-e-infusiones", "bebidas-sin-alcohol", "jugos"],
      depth: 2,
    },
    {
      name: "Bebidas instantáneas",
      slug: "bebidas-instantaneas",
      parent_id: "bebidas-sin-alcohol",
      path: [
        "bebidas-e-infusiones",
        "bebidas-sin-alcohol",
    ...
    },
    {
      ...
      slug: "cafe",
      parent_id: "bebidas-sin-alcohol",
      path: ["bebidas-e-infusiones", "bebidas-sin-alcohol", "cafe"],
      depth: 2,
    },
    {
      name: "Aguas",
      slug: "aguas",
      parent_id: "bebidas-sin-alcohol",
      path: ["bebidas-e-infusiones", "bebidas-sin-alcohol", "aguas"],
      depth: 2,
    },
    {
      name: "Otras infusiones",
      slug: "otras-infusiones",
      parent_id: "bebidas-sin-alcohol",
      path: ["bebidas-e-infusiones", "bebidas-sin-alcohol", "otras-infusiones"],
      depth: 2,
    },
    ...
    },
    {
      ...
      slug: "conservas",
      parent_id: "alimentos",
      path: ["alimentos", "conservas"],
      depth: 1,
    },
    {
      name: "Pescado y mariscos",
      slug: "pescado-mariscos",
      parent_id: "conservas",
      path: ["alimentos", "conservas", "pescado-mariscos"],
      depth: 2,
    },
    {
      ...
      parent_id: "conservas",
      path: ["alimentos", "conservas", "carnes-embutidos"],
      depth: 2,
    },
    {
      name: "Vegetales y legumbres",
      slug: "vegetales-legumbres",
      parent_id: "conservas",
      path: ["alimentos", "conservas", "vegetales-legumbres"],
      depth: 2,
    },
    {
      name: "Aceitunas",
      slug: "aceitunas",
      parent_id: "conservas",
      path: ["alimentos", "conservas", "aceitunas"],
      depth: 2,
    },
    {
      name: "Otras conservas",
      slug: "otras-conservas",
      parent_id: "conservas",
      path: ["alimentos", "conservas", "otras-conservas"],
      depth: 2,
    },
    {
      name: "Dulces",
      ...
      parent_id: "conservas",
      path: ["alimentos", "conservas", "dulces-conservas"],
      depth: 2,
    },
    {
      ...
      slug: "aceites-grasas",
      parent_id: "alimentos",
      path: ["alimentos", "aceites-grasas"],
      depth: 1,
    },
    {
      name: "Aceite vegetal",
      slug: "aceite-vegetal",
      parent_id: "aceites-grasas",
      path: ["alimentos", "aceites-grasas", "aceite-vegetal"],
      depth: 2,
    },
    {
      name: "Dulces y panes",
      slug: "dulces-panes",
      parent_id: "alimentos",
      path: ["alimentos", "dulces-panes"],
      depth: 1,
    },
    {
      name: "Caramelos y chiclets",
      slug: "caramelos-chiclets",
      parent_id: "dulces-panes",
      path: ["alimentos", "dulces-panes", "caramelos-chiclets"],
      depth: 2,
    },
    {
      name: "Galletas saladas y aperitivos",
      slug: "galletas-saladas-aperitivos",
      parent_id: "dulces-panes",
      path: ["alimentos", "dulces-panes", "galletas-saladas-aperitivos"],
      depth: 2,
    },
    {
      name: "Galletas dulces y sorbetos",
      slug: "galletas-dulces-sorbetos",
      parent_id: "dulces-panes",
      path: ["alimentos", "dulces-panes", "galletas-dulces-sorbetos"],
      depth: 2,
    },
    {
      name: "Mezclas para hornear",
      slug: "mezclas-hornear",
      parent_id: "dulces-panes",
      path: ["alimentos", "dulces-panes", "mezclas-hornear"],
      depth: 2,
    },
    {
      name: "Panes",
      slug: "panes",
      parent_id: "dulces-panes",
      path: ["alimentos", "dulces-panes", "panes"],
      depth: 2,
    },
    {
      name: "Dulces y tortas",
      slug: "dulces-tortas",
      parent_id: "dulces-panes",
      path: ["alimentos", "dulces-panes", "dulces-tortas"],
      depth: 2,
    },
    {
      name: "Turrones y chocolates",
      slug: "turrones-chocolates",
      parent_id: "dulces-panes",
      path: ["alimentos", "dulces-panes", "turrones-chocolates"],
      depth: 2,
    },
    {
      name: "Pastas, granos y cereales",
      slug: "pastas-granos-cereales",
      parent_id: "alimentos",
      path: ["alimentos", "pastas-granos-cereales"],
      depth: 1,
    },
    {
      name: "Pastas",
      slug: "pastas",
      parent_id: "pastas-granos-cereales",
      path: ["alimentos", "pastas-granos-cereales", "pastas"],
      depth: 2,
    },
    {
      name: "Cereales",
      slug: "cereales",
      parent_id: "pastas-granos-cereales",
      path: ["alimentos", "pastas-granos-cereales", "cereales"],
      depth: 2,
    },
    {
      name: "Granos",
      slug: "granos",
      parent_id: "pastas-granos-cereales",
      path: ["alimentos", "pastas-granos-cereales", "granos"],
      depth: 2,
    },
    {
      name: "Arroz",
      slug: "arroz",
      parent_id: "pastas-granos-cereales",
      path: ["alimentos", "pastas-granos-cereales", "arroz"],
      depth: 2,
    },
    {
      name: "Lácteos, huevos y helados",
      slug: "lacteos-huevos-helados",
      parent_id: "alimentos",
      path: ["alimentos", "lacteos-huevos-helados"],
      depth: 1,
    },
    {
      name: "Leche y sustitutos",
      slug: "leche-sustitutos",
      parent_id: "lacteos-huevos-helados",
      path: ["alimentos", "lacteos-huevos-helados", "leche-sustitutos"],
      depth: 2,
    },
    {
      name: "Mantequillas y margarinas",
      slug: "mantequillas-margarinas",
      parent_id: "lacteos-huevos-helados",
      path: ["alimentos", "lacteos-huevos-helados", "mantequillas-margarinas"],
      depth: 2,
    },
    {
      name: "Quesos",
      slug: "quesos",
      parent_id: "lacteos-huevos-helados",
      path: ["alimentos", "lacteos-huevos-helados", "quesos"],
      depth: 2,
    },
    {
      name: "Yogur y sustitutos",
      slug: "yogur-sustitutos",
      parent_id: "lacteos-huevos-helados",
      path: ["alimentos", "lacteos-huevos-helados", "yogur-sustitutos"],
      depth: 2,
    },
    ...
    },
    {
      name: "Plomería",
      slug: "plomeria",
      parent_id: "ferreteria",
      path: ["ferreteria", "plomeria"],
      depth: 1,
    },
    {
      name: "Misceláneas",
    ...
    {
      name: "Mobiliario y accesorios útiles",
      slug: "mobiliario-y-accesorios-utiles",
      parent_id: "hogar",
      path: ["hogar", "mobiliario-y-accesorios-utiles"],
      depth: 1,
    },
    {
      name: "Productos de limpieza - accesorios e implementos",
      slug: "productos-de-limpieza-accesorios-e-implementos",
      parent_id: "hogar",
      path: ["hogar", "productos-de-limpieza-accesorios-e-implementos"],
      depth: 1,
    },
  ];
  ...
  const catByPath = new Map(
    createdCategories.map((c) => [
      Array.isArray(c.path) ? c.path.join("-") : c.slug,
      c,
    ]),
  );
  const CATEGORY_ALIAS = {
    "bebidas-e-infusiones-bebidas-alcoholicas-cervezas": "cervezas",
    "bebidas-e-infusiones-bebidas-sin-alcohol-bebidas-gaseadas":
      "bebidas-gaseadas",
    ...
    "hogar-productos-de-limpieza-accesorios-e-implementos":
      "productos-de-limpieza-accesorios-e-implementos",
  ...
  function resolveCategory(catStr) {
    ...
    for (const [slug, c] of catBySlug.entries())
      if (mapped.endsWith(slug)) return c;
    return null;
  }
  const safePath = (c) =>
  ...
  const stores = [
    {
      tkc_code: 593,
      name: "Elizabeth Varios Cerro",
      is_shop: false,
      location: "Cerro",
    },
    {
      tkc_code: 615,
      name: "Elizabeth Electrocuba",
      is_shop: false,
      location: "Cerro",
    },
    ...
    {
      tkc_code: 734,
      name: "Electrocuba Congelados Cerro",
      is_shop: false,
      location: "Cerro",
    },
    {
    ...
    {
      tkc_code: 1000,
      name: "Línea Electrodomésticos Ligeros",
      is_shop: true,
      location: "Cerro",
    },
    {
      tkc_code: 1003,
      name: "Línea Electrodomésticos Pesados",
      is_shop: false,
      location: "Cerro",
    },
    ...
    {
      tkc_code: 1053,
      name: "B23 Electrocuba",
      is_shop: false,
      location: "Cerro",
    },
    {
      tkc_code: 1201,
      name: "B23 Electrocuba SV",
      is_shop: false,
      location: "SV",
    },
    {
      tkc_code: 1330,
      name: "Electrocuba Mayorista",
      is_shop: false,
      location: "",
    },
    {
      tkc_code: 963,
      name: "Electrocuba Lácteos FF-Yeya",
      is_shop: false,
      location: "",
    },
    {
      tkc_code: 995,
      name: "Electrocuba Lácteos FF-YeyaP",
      is_shop: false,
      location: "",
    },
    {
      tkc_code: 1138,
      name: "Línea Refrigerado FF-Yeya",
      is_shop: false,
      location: "",
    },
    {
      tkc_code: "Latino",
      name: "Electrocuba Latino",
      is_shop: true,
      location: "Latino",
    },
  ];
  ...
  for (const store of stores) {
    const created = await Store.create({
      ...store,
      tkc_code: String(store.tkc_code),
      org_id: ORG_ID,
    });
  ...
  const supplierByName = new Map(
    createdSuppliers.map((s) => [s.name.trim().toLowerCase(), s]),
  );
  ...
  const guessUPB = (slug) =>
    ["cervezas", "bebidas-gaseadas"].includes(slug)
      ? 24
      : ["jugos"].includes(slug)
        ? 12
        : ["pescado-mariscos"].includes(slug)
          ? 24
          : ["carnes-embutidos"].includes(slug)
            ? 12
            : 1;
  ...
  for (const prod of productData) {
    ...
    if (!cat)
      throw new Error(
        `Categoría no encontrada para "${prod.name}" -> "${prod.category}"`,
      );

    const sup = resolveSupplier(prod.supplier);
    if (!sup)
      throw new Error(
        `Proveedor no encontrado para "${prod.name}" -> "${prod.supplier}"`,
      );
    ...
    const barcode =
      onlyDigits(tkcCodeRaw) || `${Math.floor(Math.random() * 1e12)}`;
    ...
    for (const store of createdStores) {
      for (const product of allProducts) {
        ...
        const stock = Math.max(
          0,
          baseStock + (dailyVariation * dayOffset) / 30,
        );
  ...
  console.log(
    `   Inventory Snapshots: ${await InventorySnapshot.countDocuments({ org_id: ORG_ID })}`,
  );
  console.log(
    `   Price Lists: ${await PriceList.countDocuments({ org_id: ORG_ID })}`,
  );
  console.log(
    `   Rules: ${await ReplenishmentRule.countDocuments({ org_id: ORG_ID })}`,
  );
