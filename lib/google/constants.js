...
export const GOOGLE_DRIVE_UPLOAD_URL = 'https://www.googleapis.com/upload/drive/v3/files?uploadType=multipart&supportsAllDrives=true';
export const GOOGLE_DRIVE_FILE_URL = 'https://www.googleapis.com/drive/v3/files';
