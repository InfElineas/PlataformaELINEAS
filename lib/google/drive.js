...
import { GOOGLE_DRIVE_UPLOAD_URL, GOOGLE_DRIVE_FILE_URL, GOOGLE_SHEETS_BASE_URL } from '@/lib/google/constants';
...
export async function deleteDriveFile(fileId, token) {
  ...
  await googleApiFetch(url, { method: 'DELETE', token, responseType: 'text' }).catch(() => {});
}
