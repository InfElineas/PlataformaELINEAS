...
const ProductSchema = new mongoose.Schema(
  {
    ...
    // Datos operativos para la vista de productos (campos base en español)
    existencia_fisica: { type: Number, default: 0, alias: "physical_stock" }, // EF
    reserva: { type: Number, default: 0, alias: "reserve_qty" }, // A
    disponible_tienda: { type: Number, default: 0, alias: "store_qty" }, // T
