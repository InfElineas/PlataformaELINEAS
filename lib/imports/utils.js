...
// Siempre permitir que el nombre de campo canónico funcione como encabezado
// después de normalizarlo.
for (const key of Object.keys(PRODUCT_FIELD_ALIASES)) {
  aliasMap.set(normalizeHeader(key), key);
}
