...
export const PRODUCT_FIELD_ALIASES = {
  online_category: ['Categoría Online', 'categoria online', 'category online', 'cat online'],
  store_external_id: ['idTienda', 'id tienda', 'store id', 'id tienda externo'],
  product_code: ['Cód. Prod.', 'cod. prod.', 'código', 'codigo', 'product code'],
  ...
  physical_stock: ['Existencia física', 'existencia fisica', 'stock', 'stock fisico'],
  warehouse_name: ['Almacén', 'almacen', 'warehouse'],
